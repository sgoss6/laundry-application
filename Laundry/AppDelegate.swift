...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var window: UIWindow?
    private let baseURLString: String = "https://laundry-70805.firebaseio.com"
    private let publishableKey: String = "pk_test_IuntzXmhyAuep7pkWxQXCrYJ"
    
    override init() {
        super.init()
        
        // Stripe payment configuration
        STPPaymentConfiguration.shared().companyName = "Laundry"
